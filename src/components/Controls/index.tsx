...
export const Controls = () => {
  ...
  return (
    <Box>
      <Box sx={{display: 'flex', justifyContent: 'space-between', width: '424px' }}>
        ...
        <IconButton /*variant="contained"*/ component="label" sx={{background: 'rgba(99, 113, 201, 1)', color: '#FFFFFF', padding: '15px'}}>
